...
const AddLinkBanner = () => {
  ...
  useEffect(() => {
    console.log('Link data from AddLinkBanner', linkData)
  }, [linkData])
  return (
    <>
      ...
      <button className='bg-white border border-blue-500 text-blue-500 px-4 py-1 rounded-lg w-full' onClick={addNewLinkTemplate}>Add new link</button>
    </>
  )
}
